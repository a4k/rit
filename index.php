...
?>
                    ...
                    <div class="cards product-cards s-color ct_3 ctm_1 cts_1">
                        <div class="card slide" data-color="#E96060" data-tcolor="#fff">
                            ...
                            <div class="card_body">
                                ...
                                <p class="card_text">
                                    Комплексно-правовая система для автоматизации полного цикла работ по сопровождению
                                    процедур банкротства
                                </p>
                            </div>
                            <a href="/pau" class="card_link"><span></span></a>
                        </div>
                        ...
                        <div class="card slide" data-item="cardPrint" data-color="#5D5A57" data-tcolor="#fff">
                            <div style="background-image: url(/upload/images/item/prod4-2.png)" class="holder_image card_photo"></div>
                            <div class="card_body">
                                <h5 class="card_title"><a>Печать конвертов</a></h5>
                                <p class="card_text">Автоматическая печать конвертов, печать реестров, уведомлений,
                                    ведение баз данных контрагентов и проведённых рассылок.</p>
                            </div>
                            <a href=/products/fa"
                               class="card_link" target="_blank">
                                <span></span></a>
                        </div>
                        <div class="card slide" data-item="cardProbili" data-color="#CD4550" data-tcolor="#fff">
                            <div style="background-image: url(/upload/images/item/prod5.png)" class="holder_image card_photo"></div>
                            <div class="card_body">
        ...
        <section class="block_content services">
            <div class="container">
                ...
                <div class="s_container services_about">
                    <p>
                        Мы предлагаем полный комплекс услуг для проектов любого уровня и любой стадии готовности — от
                        начальной, когда есть лишь идея, нуждающаяся в разработке, создании инструментов и продвижении,
                        до заключительной, когда ресурсу необходима только поддержка.
                    </p>
                </div>
                <div class="cards ct_3 ctm_1 cts_1">
                    ...
                    <div class="card">
                        <div class="card_body">
                            ...
                            <p class="card_text">
                                - Бизнес-анализ и консалтинг<br/>
                                - Разработка заказных ERP и CRM<br/>
                                - Внедрение, развертывание, <span class="lindent"></span>интеграция и настройка<br/>
                            </p>
                        </div>
                        <div class="card_icon"></div>
                    </div>
        ...
        <section class="block_content company">
            <div class="container">
                ...
                <div class="s_container company_about">
                    <p>
                        Политика фирмы заключается в том, чтобы предоставить клиенту возможность выбора программного
                        продукта,
                        который наибольшим образом будет соответствовать его целям и задачам,
                        во внедрении этого программного продукта, настройке его под конкретные
                        требования клиента, которые почти всегда отличаются своей спецификой, и дальнейшем
                        сопровождении.
                    </p>
                </div>
    ...
    <style>
        ...
        .cards.product-cards .card[data-item="cardPrint"]:hover .card_photo {
            background-image: url(/upload/images/item/prod4-3.png) !important;
        }

        .cards.product-cards .card[data-item="cardProbili"]:hover .card_photo {
            background-image: url(/upload/images/item/prod5-2.png) !important;
        }
    </style>
